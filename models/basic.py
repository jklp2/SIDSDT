...
class Model(Base):
    ...
    def initialize(self, opt):
        ...
        syn_encoder=DRNet(3, 32, 256, 1, nn.InstanceNorm2d, None, 1, 3, False).cuda()
        syn_decoder=DRNet(32, 3, 256, 1, nn.InstanceNorm2d, None, 1, 3, False).cuda()
        real_encoder=DRNet(3, 32, 256, 1, nn.InstanceNorm2d, None, 1, 3, False).cuda()
        real_decoder=DRNet(32, 3, 256, 1, nn.InstanceNorm2d, None, 1, 3, False).cuda()
        fea_disc=NLayerDiscriminator(64).cuda()
        disc=NLayerDiscriminator(3).cuda()
